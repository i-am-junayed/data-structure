### QUESTION : Write a function named print_levels(self) that will print the levels of a BST. [ You can only use an queue ]
...
class BinarySearchTree:
    ...
    def print_levels_wise_sum(self):
        if self.root is None:
            return
